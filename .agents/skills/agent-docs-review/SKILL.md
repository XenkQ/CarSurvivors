...
2. Read project source-of-truth docs before editing:
   ...
   - `agent-docs/technology-documentation.md` when framework or package behavior is mentioned.
   - `agent-docs/project-coding-standards.md` when conventions or coding rules are mentioned.
   - `.agents/README.md` when operational agent files are mentioned.
...
5. Rewrite the document for agent use:
   ...
   - Keep markdown filenames kebab-case under `agent-docs/` unless the file is a reserved name.
